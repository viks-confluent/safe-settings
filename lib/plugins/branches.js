...
module.exports = class Branches {
  ...
  reformatBranchProtection (protection) {
    ...
    // apps. We have filed a github bug. Until that is fixed, we will not be supporting the restrictions via
    // safe-settings GQL. https://support.github.com/ticket/enterprise/2291/1919562
